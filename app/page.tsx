  ...
  return (
    ...
    >
      ...
      <section className="min-h-screen flex items-center justify-center px-4 py-8 sm:py-12 lg:py-16 relative">
        ...
        {/* Subtle Pattern Overlay - Responsive positioning */}
        <div className="absolute inset-0 opacity-5 dark:opacity-10">
          <div className="absolute top-10 left-4 sm:top-20 sm:left-20 w-16 h-16 sm:w-32 sm:h-32 bg-blue-500 rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 right-4 sm:bottom-20 sm:right-20 w-20 h-20 sm:w-40 sm:h-40 bg-purple-500 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/4 w-12 h-12 sm:w-24 sm:h-24 bg-cyan-500 rounded-full blur-2xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-8 text-center lg:text-left space-y-4 sm:space-y-6">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-2 bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 bg-clip-text text-transparent leading-tight">
                DHEERAAJ<br />PINJALA
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mt-6 px-4 lg:px-0">
                <a href="/resume.pdf" target="_blank" rel="noopener noreferrer">
                  <button className="group relative w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-sm sm:text-base rounded-xl shadow-2xl hover:shadow-blue-500/25 transform hover:-translate-y-1 transition-all duration-300">
                ...
                <Link href="/contact">
                  <button className="group w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 border-2 border-blue-600 text-blue-600 font-bold text-sm sm:text-base rounded-xl hover:bg-blue-600 hover:text-white transform hover:-translate-y-1 transition-all duration-300">
                    Let's Connect
                  </button>
                </Link>
              </div>
              ...
              <div className="flex space-x-3 sm:space-x-4 justify-center lg:justify-start mt-6 px-4 lg:px-0">
                <a href="https://github.com/Dheeraaj-8" target="_blank" rel="noopener noreferrer" className="group p-3 sm:p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-full shadow-lg hover:shadow-xl hover:shadow-blue-500/20 dark:hover:shadow-blue-400/20 transform hover:-translate-y-1 transition-all duration-300">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://linkedin.com/in/dheeraaj-pinjala" target="_blank" rel="noopener noreferrer" className="group p-3 sm:p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-full shadow-lg hover:shadow-xl hover:shadow-blue-500/20 dark:hover:shadow-blue-400/20 transform hover:-translate-y-1 transition-all duration-300">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="mailto:dheeraajpinjala@gmail.com" className="group p-3 sm:p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-full shadow-lg hover:shadow-xl hover:shadow-blue-500/20 dark:hover:shadow-blue-400/20 transform hover:-translate-y-1 transition-all duration-300">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="lg:col-span-4 flex justify-center order-first lg:order-last">
              <div className="relative">
                ...
                <div className="w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-3xl overflow-hidden shadow-2xl hover:shadow-blue-600/50 dark:hover:shadow-blue-400/60 hover:shadow-4xl hover:scale-105 transition-all duration-500 group relative">
                  {/* Glow ring */}
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-gray-700 dark:to-blue-900 flex items-center justify-center relative z-10" style={{display: 'none'}}>
                    <span className="text-4xl sm:text-6xl font-black text-blue-600 dark:text-blue-400">DP</span>
                  </div>
                </div>
