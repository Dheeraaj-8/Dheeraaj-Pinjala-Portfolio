...
export default function Portfolio() {
  ...
  return (
    <div
      className={`h-screen flex flex-col ${darkMode ? "dark bg-gray-900 text-white" : "bg-white text-gray-900"}`}
    >
      {/* Navigation */}
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <section className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 relative overflow-hidden">
        {/* Background Gradient */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 text-center lg:text-left space-y-6">
              {/* Name - Much Larger */}
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-4 bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 bg-clip-text text-transparent leading-tight">
                DHEERAAJ<br />PINJALA
              </h1>
              
              {/* Tagline - Enhanced */}
              <p className="text-base md:text-lg lg:text-xl font-semibold text-gray-700 dark:text-gray-200 mb-4 tracking-wide">
                AI Enthusiast • Cloud & DevOps Practitioner • Ex-Software Engineer
              </p>
              
              {/* Location & Experience - Larger */}
              <div className="flex items-center justify-center lg:justify-start text-gray-600 dark:text-gray-300 mb-6 text-base">
              ...
              <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto lg:mx-0 leading-relaxed">
              ...
              <div className="flex space-x-4 justify-center lg:justify-start mt-6">
                <a href="https://github.com/Dheeraaj-8" target="_blank" rel="noopener noreferrer" className="group p-3 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                ...
                <a href="https://linkedin.com/in/dheeraaj-pinjala" target="_blank" rel="noopener noreferrer" className="group p-3 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-blue-600 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="mailto:dheeraajpinjala@gmail.com" className="group p-3 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="relative">
                ...
                <img 
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-gray-700 dark:to-blue-900 flex items-center justify-center" style={{display: 'none'}}>
                    <span className="text-5xl font-black text-blue-600 dark:text-blue-400">DP</span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full opacity-30 animate-pulse delay-1000"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* About Section */}
        <section className="py-4 px-4 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-lg font-bold text-center mb-4">About Me</h2>
          <div className="max-w-3xl mx-auto">
            <p className="text-xs text-gray-600 dark:text-gray-300 mb-2 text-justify leading-relaxed">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300 text-justify leading-relaxed">
      ...
      {/* Footer */}
      <footer className="py-6 px-4 border-t bg-gray-50 dark:bg-gray-800 flex-shrink-0">
