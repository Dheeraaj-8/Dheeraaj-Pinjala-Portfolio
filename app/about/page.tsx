...
export default function About() {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-8 text-center lg:text-left space-y-4 sm:space-y-6 order-last lg:order-first">
              {/* Name - Much Larger */}
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-2 bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 dark:from-purple-400 dark:via-purple-500 dark:to-purple-600 bg-clip-text text-transparent leading-tight">
                DHEERAAJ<br />PINJALA
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-4">
                <a href="/resume.pdf" target="_blank" rel="noopener noreferrer">
                  <button className="group relative px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 dark:from-purple-600 dark:to-purple-700 text-white font-bold text-base rounded-xl shadow-2xl hover:shadow-blue-500/25 dark:hover:shadow-purple-500/25 transform hover:-translate-y-1 transition-all duration-300">
                ...
                <Link href="/contact">
                  <button className="group px-6 py-3 border-2 border-blue-600 dark:border-purple-600 text-blue-600 dark:text-purple-400 font-bold text-base rounded-xl hover:shadow-blue-500/50 dark:hover:shadow-purple-500/50 hover:shadow-2xl dark:hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                    Let's Connect
                  </button>
                </Link>
              </div>
              ...
              <div className="flex space-x-4 justify-center lg:justify-start mt-4">
                <a href="https://github.com/Dheeraaj-8" target="_blank" rel="noopener noreferrer" className="group p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-purple-800/30 rounded-full shadow-lg hover:shadow-xl hover:shadow-blue-500/20 dark:hover:shadow-purple-500/30 transform hover:-translate-y-1 transition-all duration-300">
                  <svg className="w-6 h-6 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-purple-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://linkedin.com/in/dheeraaj-pinjala" target="_blank" rel="noopener noreferrer" className="group p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-purple-800/30 rounded-full shadow-lg hover:shadow-xl hover:shadow-blue-500/20 dark:hover:shadow-purple-500/30 transform hover:-translate-y-1 transition-all duration-300">
                  <svg className="w-6 h-6 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-purple-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="mailto:dheeraajpinjala@gmail.com" className="group p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-purple-800/30 rounded-full shadow-lg hover:shadow-xl hover:shadow-blue-500/20 dark:hover:shadow-purple-500/30 transform hover:-translate-y-1 transition-all duration-300">
                  <svg className="w-6 h-6 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="lg:col-span-4 flex justify-center order-first lg:order-last">
              <div className="relative">
                ...
                <div className="w-64 h-64 lg:w-80 lg:h-80 rounded-3xl overflow-hidden shadow-2xl hover:shadow-blue-600/50 dark:hover:shadow-purple-500/60 hover:shadow-4xl hover:scale-105 transition-all duration-500 group relative">
                  {/* Glow ring */}
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-gray-800 dark:to-purple-900 flex items-center justify-center relative z-10" style={{display: 'none'}}>
                    <span className="text-6xl font-black text-blue-600 dark:text-purple-400">DP</span>
                  </div>
                </div>
      ...
      {/* About Section */}
      <section className="py-12 sm:py-16 px-4 bg-gray-50 dark:bg-gray-900 dark:bg-gradient-to-br dark:from-gray-900 dark:to-slate-900">
